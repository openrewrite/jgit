...
import org.openrewrite.jgit.errors.NoMergeBaseException.MergeBaseFailureReason;
...
/**
 * Instance of a specific {@link org.openrewrite.jgit.merge.MergeStrategy} for a
 * single {@link org.openrewrite.jgit.lib.Repository}.
 */
